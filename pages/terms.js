        ...
        <div className="container mx-auto flex flex-col items-center px-5 pt-24 pb-36 md:flex-row-reverse">
          <div className="flex flex-col items-center text-center md:items-start md:pl-16 md:text-left lg:flex-grow lg:pl-24">
            ...
            <ul className="flex flex-col pb-8 pl-9 font-lato text-lg">
              ...
              <li className="pb-4">
                <strong className="pr-2 font-semibold">Services</strong>refer to our Website and Web
                Application.
              </li>
              <li className="pb-4">
                <strong className="pr-2 font-semibold">Terms and Conditions</strong>(also referred
                as "Terms") mean these Terms and Conditions that form the entire agreement between
                You and the Company regarding the use of the Service. This Terms and Conditions
              ...
              <li className="pb-4">
                <strong className="pr-2 font-semibold">You</strong>means the individual accessing or
